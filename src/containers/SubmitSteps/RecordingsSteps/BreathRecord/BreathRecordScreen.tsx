...
const BreathRecordScreen: React.FC = () => {
    ...
    const startRecording = async () => {
        try {
            ...
            recorder.onstop = () => {
                ...
                setAudioUrl(url);
                setFileName(`breath-${Date.now()}.webm`);
            };
    ...
    return (
        <div style={{ minHeight: "100vh", padding: "1.5rem 1rem", fontFamily: "Source Sans Pro, sans-serif", fontSize: "14px", display: "flex", justifyContent: "center", backgroundColor: "transparent" }}>
            <div style={{ maxWidth: "1000px", width: "100%", position: "relative" }}>
                ...
                <div style={{ position: "relative", marginTop: "1.25rem", marginBottom: "1.75rem" }}>
                    ...
                    >
                        <img src={BackIcon} alt={t("recordBreath.goBackAlt")} width={24} height={24} style={{ transform: isArabic ? "rotate(180deg)" : "none" }} />
                    </button>
                    <div style={{ textAlign: "center", fontWeight: 600, fontSize: "18px", color: "#3578de" }}>{t("recordBreath.title")}</div>
                </div>

                {/* Instructions */}
                <h3 style={{ textAlign: "center", fontWeight: "bold", fontSize: "32px", marginBottom: "2rem", marginTop: "3rem" }}>
                ...
                <img src={keepDistance} alt={t("recordBreath.keepDistanceAlt")} style={{ width: "50%", margin: "auto", display: "block", marginBottom: "2rem" }} />

                {/* Step 2 */}
                <div style={{ display: "flex", alignItems: "flex-start", gap: "1rem", marginBottom: "1rem" }}>
                    <div style={{ minWidth: "28px", height: "28px", backgroundColor: "#DDE9FF", borderRadius: "50%", textAlign: "center", lineHeight: "28px", fontWeight: "bold", color: "#3578de", fontSize: "14px" }}>2</div>
                    <div style={{ flex: 1 }}>
                ...
                <img src={mouthBreathDistance} alt={t("recordBreath.mouthDistanceAlt")} style={{ width: "50%", margin: "auto", display: "block", marginBottom: "2rem" }} />
                ...
                <div style={{ display: "flex", justifyContent: "center", gap: "2rem", marginBottom: "2.5rem" }}>
                    <div style={{ textAlign: "center" }}>
                        ...
                        <div style={{ fontSize: "18px", marginTop: "0.5rem", color: "#666" }}>{t("recordBreath.recordButton")}</div>
                    </div>
                    <div style={{ textAlign: "center" }}>
                        ...
                        <div style={{ fontSize: "18px", marginTop: "0.5rem", color: "#666" }}>{t("recordBreath.stopButton")}</div>
                    </div>
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "1rem", marginBottom: "1rem" }}>
                    ...
                    <button onClick={handleContinue} style={{ backgroundColor: "#3578de", color: "#fff", border: "none", padding: "1.5rem", borderRadius: "15px", fontWeight: "bold", cursor: "pointer" }}>
                        {t("recordBreath.continueButton")}
                    </button>
                    <button onClick={handleUploadClick} style={{ background: "none", border: "none", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}>
                        <img src={UploadIcon} alt={t("recordBreath.uploadFile")} width={22} height={22} style={{ marginRight: "0.5rem" }} />
                        <span style={{ fontSize: "12px", fontWeight: 600 }}>{t("recordBreath.uploadFile")}</span>
                    </button>
